...
class ObservabilityService:
    ...
    - CSV file (comprehensive_metrics.csv)
    ...
    def __init__(self, csv_path: str = None, prom_path: str = None, 
        ...
        Args:
            ...
            prom_path: Path to Prometheus metrics file
    ...
    def start(self):
        ...
        # Main loop - export to Prometheus periodically
        try:
            while self.running:
...
def start_observability_process(csv_path: str = None, prom_path: str = None, 
    ...
    Args:
        ...
        prom_path: Path to Prometheus file
